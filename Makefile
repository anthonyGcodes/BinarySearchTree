...
#SRCS = ${wildcard *.cpp}
OBJS = ${SRCS:.cpp=.o}
INCLS = ${SRCS:.cpp=.h} bst.h treenode.h main.h
#INCLS = ${SRCS:.cpp=.h} 
#INCLS = ${wildcard *.h}
...
submit:
	rm -f submit.zip
	zip submit.zip $(SRCS) $(INCLS) HONOR Makefile Makefile.dep p2_test0.txt p2_test1.txt p2_test2.txt p2_test3.txt p2_test4.txt
